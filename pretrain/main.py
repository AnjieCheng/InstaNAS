...
from models.instanas import MobileNet, MobileNet_64, MobileNet_224
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs + 1):
        ...
        # train for one epoch
        train_loss, train_err1, train_err5, lr, drop_path_prob = trainer.train(
            train_loader, epoch)
        ...
        if args.tensorboard:
            ...
            log_value('drop_path_prob', drop_path_prob, epoch)
        ...
        # accidental deletion
        scores.append(('{}\t{}' + '\t{:.4f}' * 6)
                      .format(epoch, lr, train_loss, val_loss, train_err1, val_err1, train_err5, val_err5))
